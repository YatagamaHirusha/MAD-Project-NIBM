...
public final class UserInterestStore {
    ...
    public static void save(Context context, String location, String occupation, Map<String, List<String>> interestsByColumn) {
        save(context, location, occupation, interestsByColumn, false);
    }

    /**
     * Same as {@link #save(Context, String, String, Map)} but uses {@link SharedPreferences.Editor#commit()} so a
     * following screen read (e.g. dashboard right after cloud sync) never sees stale empties.
     */
